...
var refdate = new Date();var dnthresh = basedate.getTime() + (refdate.getTimezoneOffset() - basedate.getTimezoneOffset()) * 60000;
...
function parse_clrScheme(t, opts) {
	...
	//fix for bug with theme elements order bor lt/dk themes
...
function write_ws_xml_cell(cell, ref, ws, opts, idx, wb) {
  //if (cell.v === undefined && cell.s === undefined && !cell.f) return ""; //patch
  ...
  switch (cell.t) {
    ...
    var v = vv === "" && cell.t == "z" ? "" : writetag('v', escapexml(vv)), o = {r: ref};// old
 	// var o = { r: ref }; //patch
